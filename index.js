...
function filterTodos(filter) {
    ...
    switch (filter) {
        case 'all':
            ...
            break;
        case 'checked':
            filteredTodos = todoList.filter(todo => todo.status);
            break;
        case 'unchecked':
            filteredTodos = todoList.filter(todo => !todo.status);
            break;
    ...
    filteredTodos.forEach(todo => {
        todoListContainer.innerHTML += todo.html;
    });
...
document.querySelector('.filter.all').addEventListener('click', () => filterTodos('all'));
document.querySelector('.filter.checked').addEventListener('click', () => filterTodos('checked'));
document.querySelector('.filter.unchecked').addEventListener('click', () => filterTodos('unchecked'));
